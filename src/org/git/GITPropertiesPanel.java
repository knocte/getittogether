...
//        su.setMinimumSize(new Dimension(PREFERRED_WIDTH, PREFERRED_HEIGHT));
        ...
        items.add("External");
        JComboBox player = new JComboBox(items);
        player.addActionListener(this);
        player.setMaximumSize(new Dimension(120, 40));
        ...
        gui.add(createGITCheckBox("Hide music not supported by current player", "hideUnsupportedSongs"));
